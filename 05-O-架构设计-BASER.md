...
## Requirement
请帮我进行业务架构设计：
1. 识别系统中的核心业务实体，列出每个实体的业务属性
2. 画出业务实体之间的关系（用 Mermaid 图）
